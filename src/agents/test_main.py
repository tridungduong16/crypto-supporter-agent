...
class AIApplication:
    ...
    def chat(self, message: str):
        ...
        print(message)
        response = self.agent.chat(message)  # Assuming 'achat' is the async method
        return str(response)
...
# query="Volume giao dịch lớn nhất trên binance"
# response = ai_app.chat(query)
# print(response)

query="Hãy dự đoán giá bitcoin vào tháng 1 năm 2025"
response = ai_app.chat(query)
print(response)


query="Hãy dự đoán giá bitcoin vào tháng 1 năm 2026"
response = ai_app.chat(query)
print(response)
...
# query="Hãy dự đoán giá bitcoin vào tháng 1 năm 2040"
# response = ai_app.chat(query)
# print(response)
